...
for ep in range(1, 7):
    ...
    fan_objs = [create_obj_struct(f"Btn{ep}_FanPow", "Power", "1 Bit", "DPST-1-1", fan_ui), create_obj_struct(f"Btn{ep}_FanSpd", "Fan speed", "1 Byte", "DPST-5-10", fan_ui), create_obj_struct(f"Btn{ep}_FanPowS", "Power status", "1 Bit", "DPST-1-1", fan_ui, is_status=True), create_obj_struct(f"Btn{ep}_FanSpdS", "Fan speed status", "1 Byte", "DPST-5-10", fan_ui, is_status=True)]
    ac_ui = f"Endpoint {ep} - Air conditioner"
    ac_objs = [create_obj_struct(f"Btn{ep}_AcPow", "Power", "1 Bit", "DPST-1-1", ac_ui), create_obj_struct(f"Btn{ep}_AcTar", "Setpoint", "2 Bytes", "DPST-9-1", ac_ui), create_obj_struct(f"Btn{ep}_AcMod", "Mode", "1 Byte", "DPST-20-105", ac_ui), create_obj_struct(f"Btn{ep}_AcFan", "Fan speed", "1 Byte", "DPST-5-10", ac_ui), create_obj_struct(f"Btn{ep}_AcSwi", "Air swing", "1 Bit", "DPST-1-1", ac_ui), create_obj_struct(f"Btn{ep}_AcVan", "Louver position", "1 Byte", "DPST-5-10", ac_ui), create_obj_struct(f"Btn{ep}_AcPowS", "Power status", "1 Bit", "DPST-1-1", ac_ui, is_status=True), create_obj_struct(f"Btn{ep}_AcTarS", "Setpoint status", "2 Bytes", "DPST-9-1", ac_ui, is_status=True), create_obj_struct(f"Btn{ep}_AcModS", "Mode status", "1 Byte", "DPST-20-105", ac_ui, is_status=True), create_obj_struct(f"Btn{ep}_AcFanS", "Fan speed status", "1 Byte", "DPST-5-10", ac_ui, is_status=True), create_obj_struct(f"Btn{ep}_AcSwiS", "Air swing status", "1 Bit", "DPST-1-1", ac_ui, is_status=True), create_obj_struct(f"Btn{ep}_AcVanS", "Louver position status", "1 Byte", "DPST-5-10", ac_ui, is_status=True)]
    he_ui = f"Endpoint {ep} - Heater"
    he_objs = [create_obj_struct(f"Btn{ep}_HePow", "Heater power", "1 Bit", "DPST-1-1", he_ui), create_obj_struct(f"Btn{ep}_HeTar", "Set temperature threshold", "2 Bytes", "DPST-9-1", he_ui), create_obj_struct(f"Btn{ep}_HeMode", "Enable control", "1 Bit", "DPST-1-1", he_ui), create_obj_struct(f"Btn{ep}_HePowS", "Heater power status", "1 Bit", "DPST-1-1", he_ui, is_status=True), create_obj_struct(f"Btn{ep}_HeTarS", "Set temperature threshold status", "2 Bytes", "DPST-9-1", he_ui, is_status=True), create_obj_struct(f"Btn{ep}_HeModeS", "Enable control status", "1 Bit", "DPST-1-1", he_ui, is_status=True), create_obj_struct(f"Btn{ep}_HeRmT", "Room temperature", "2 Bytes", "DPST-9-1", he_ui, is_status=True)]
    ...
    endpoints_logic.append({
        ...
        "ac": {"rid_step": rid_ac_step, "rid_min": rid_ac_min_temp, "rid_max": rid_ac_max_temp, "rid_en_auto": rid_ac_en_auto, "rid_en_heat": rid_ac_en_heat, "rid_en_cool": rid_ac_en_cool, "rid_en_dry": rid_ac_en_dry, "rid_en_fan": rid_ac_en_fan, "rid_fan_auto": rid_ac_fan_auto, "rid_fan_type": rid_ac_fan_type, "rid_swi_type": rid_ac_swi_type, "objs": ac_objs},
        "he": {"objs": he_objs},
    })
...
L('            <LoadProcedures>')
L('              <LoadProcedure MergeId="2"><LdCtrlRelSegment AppliesTo="full" LsmIdx="4" Size="1024" Mode="0" Fill="0" /></LoadProcedure>')
L('              <LoadProcedure MergeId="4"><LdCtrlWriteRelMem ObjIdx="4" Offset="0" Size="1024" Verify="true" /></LoadProcedure>')
L('            </LoadProcedures>')
L('          </Static>')
L('          <Dynamic>')
