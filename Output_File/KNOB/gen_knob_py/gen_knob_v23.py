...
for ep in range(1, 7):
    ...
    endpoints_logic.append({
        ...
        "ac": {"rid_step": rid_ac_step, "rid_min": rid_ac_min_temp, "rid_max": rid_ac_max_temp, "rid_en_auto": rid_ac_en_auto, "rid_en_heat": rid_ac_en_heat, "rid_en_cool": rid_ac_en_cool, "rid_en_dry": rid_ac_en_dry, "rid_en_fan": rid_ac_en_fan, "rid_fan_auto": rid_ac_fan_auto, "rid_fan_type": rid_ac_fan_type, "rid_en_swi": rid_ac_en_swi, "rid_swi_pos": rid_ac_swi_pos, "objs": ac_objs},
        "he": {"objs": he_objs},
    })
