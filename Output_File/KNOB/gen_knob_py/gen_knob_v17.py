...
# Date: 2026-04-18
# Changes from v16:
# 1. Added 5 toggles (Auto, Heat, Cool, Dry, Fan) for Air condition endpoint
...
for ep in range(1, 7):
    ...
    endpoints_logic.append({
        ...
        "fan": {"objs": fan_objs},
        "ac": {"rid_step": rid_ac_step, "rid_en_auto": rid_ac_en_auto, "rid_en_heat": rid_ac_en_heat, "rid_en_cool": rid_ac_en_cool, "rid_en_dry": rid_ac_en_dry, "rid_en_fan": rid_ac_en_fan, "objs": ac_objs},
        "th": {"objs": th_objs},
    })
...
with open(output_path, "w", encoding="utf-8") as f:
    f.write("\n".join(lines) + "\n")
print(f"Generated knob_device.xml v17: Added AC Mode toggles, memory budget checked.")
