...
#define VD_OP_RESERVE_FOR_TELINK_END    0xDA
...
// Light Speaker API
#define VD_LIGHT_SPEAKER_GET            0xFA
#define VD_LIGHT_SPEAKER_SET            0xFB
#define VD_LIGHT_SPEAKER_SET_NOACK      0xFC
#define VD_LIGHT_SPEAKER_STATUS         0xFD

// Test Led
#define VD_LIGHT_AUTO_TEST_SET_NOACK    0xFF
...
void sw_setup_device_information_response_delay(u16 ms);
