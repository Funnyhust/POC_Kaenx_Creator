...
static inline u32 clock_time_get_elapsed_time(u32 start_ms){
	return (system_time_ms - start_ms);
}
...
typedef void (*type_funcRun100msInterval)(void);
typedef void (*type_handleUpdateStatePeriodically)(void);

void system_time_callback_init(
		type_handleUpdateStatePeriodically callback_func,
		type_funcRun100msInterval callback_func_1
		);
