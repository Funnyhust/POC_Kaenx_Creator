...
#define PUBLISH_PW_RANDOM_TIME	   5000      // 5s
#define PUBLISH_PW_TIME	           120000    // 2 minutes

#define MAX_BEACON_SEND_INTERVAL 	        5000*1000
...
extern u32 publish_status_periodically_ms;
...
typedef void (*typeCommon_HandleRxMessageFunc)(u8*, int);
void handle_rx_message_callback_init(typeCommon_HandleRxMessageFunc pCallback);
void publish_status_periodically(void);
void set_publish_status_periodically_interval(void);
