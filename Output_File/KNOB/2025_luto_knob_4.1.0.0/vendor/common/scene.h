...
#if MD_LEVEL_EN
typedef u8 (*type_handle_get_level_callback_func)(u8);
//
void scene_callback_init(type_handle_get_level_callback_func callbackFunc);
extern type_handle_get_level_callback_func pv_handle_get_level;
#endif

// 28/9/2022
typedef void (*typeSCENE_setUpSceneRegisterRspDelay)(u8 model_idx, u16 dst_adr, u8 st);
