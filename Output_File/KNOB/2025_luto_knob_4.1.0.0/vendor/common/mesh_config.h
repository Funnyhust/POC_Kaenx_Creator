...
#define LIGHT_TYPE_2WW_1DIM         20
#define LIGHT_TYPE_1WW_3DIM         21

#define LIGHT_TYPE_RGB_AND_WW       22

#define LIGHT_TYPE_2_CCT            23

// Additional Device
#define LIGHT_TYPE_TOUCH_SWITCH     0x0020
#define LIGHT_TYPE_ROUTER           0x0021
...
#define LIGHT_TYPE_SEL				LIGHT_TYPE_PANEL
		#endif
	#else
		#ifdef _CT_LIGHT_DEVICE_
			#define LIGHT_TYPE_SEL	LIGHT_TYPE_CT
		#endif

		#ifdef _HSL_LIGHT_DEVICE_
			#define LIGHT_TYPE_SEL	LIGHT_TYPE_HSL
		#endif

		#ifdef _XYL_LIGHT_DEVICE_
			#define LIGHT_TYPE_SEL	LIGHT_TYPE_XYL
		#endif

		#ifdef _POWER_LIGHT_DEVICE_
			#define LIGHT_TYPE_SEL	LIGHT_TYPE_POWER
		#endif

		#ifdef _CT_HSL_LIGHT_DEVICE_
			#define LIGHT_TYPE_SEL	LIGHT_TYPE_CT_HSL
		#endif

		#ifdef _DIM_LIGHT_DEVICE_
			#define LIGHT_TYPE_SEL	LIGHT_TYPE_DIM
		#endif

		#ifdef _TOUCH_PANEL_DEVICE_
			#define LIGHT_TYPE_SEL	LIGHT_TYPE_PANEL
		#endif

		#ifdef _DIMMER_DEVICE_
			#define LIGHT_TYPE_SEL  LIGHT_TYPE_DIM
		#endif

		#ifdef _2WW_1DIM_DEVICE_
			#define LIGHT_TYPE_SEL  LIGHT_TYPE_2WW_1DIM
            #define ARR_ELE_WITH_CTL_CONTROL  { TRUE, TRUE, FALSE }
		#endif

		#ifdef _1WW_3DIM_DEVICE_
			#define LIGHT_TYPE_SEL  LIGHT_TYPE_1WW_3DIM
            #define ARR_ELE_WITH_CTL_CONTROL  { TRUE, FALSE, FALSE, FALSE }
		#endif

		#ifdef _RGB_AND_WW_LIGHT_DEVICE_
            #define LIGHT_TYPE_SEL  LIGHT_TYPE_RGB_AND_WW
		#endif

		#ifdef _TWO_CCT_DEVICE_
			#define LIGHT_TYPE_SEL    LIGHT_TYPE_2_CCT
		#endif

		#ifdef _SWITCH_DEVICE_
			#define LIGHT_TYPE_SEL  G_TYPE_SWITCH_BUTTON
		#endif

		#ifdef _LM_CURTAIN_DEVICE_
			#define LIGHT_TYPE_SEL  G_TYPE_LM_CURTAIN
		#endif

		#ifdef _LM_DIMMER_DEVICE_
			#define LIGHT_TYPE_SEL  G_TYPE_LM_DIMMER
		#endif

		#ifdef _LM_FAN_DEVICE_
			#define LIGHT_TYPE_SEL  G_TYPE_LM_FAN
		#endif

        #define DEV_TYPE_SEL        LIGHT_TYPE_SEL
...
#else
    #define EN_EXECUTION_SCENE      0
#endif

#if DEV_TYPE_SEL == G_TYPE_SWITCH_BUTTON || DEV_TYPE_SEL == G_TYPE_LM_DIMMER || DEV_TYPE_SEL == G_TYPE_LM_GATE
    #define DEV_SUPPORT_BINDING     1
#else
    #define DEV_SUPPORT_BINDING     0
#endif

#if (LIGHT_TYPE_SEL == LIGHT_TYPE_CT) 						      \
		|| (LIGHT_TYPE_SEL == LIGHT_TYPE_CT_HSL) 			      \
			|| ( LIGHT_TYPE_SEL == LIGHT_TYPE_2WW_1DIM ) 	      \
				|| ( LIGHT_TYPE_SEL == LIGHT_TYPE_1WW_3DIM )      \
					|| ( LIGHT_TYPE_SEL == LIGHT_TYPE_RGB_AND_WW) \
						|| ( LIGHT_TYPE_SEL == LIGHT_TYPE_2_CCT ) \
                        	|| (LIGHT_TYPE_SEL  == G_TYPE_SWITCH_BUTTON)  \
...
#if (LIGHT_TYPE_SEL == LIGHT_TYPE_PANEL) || (LIGHT_TYPE_SEL == G_TYPE_SWITCH_BUTTON)||(LIGHT_TYPE_SEL == G_TYPE_LM_GATE)
...
#define MD_MESH_OTA_EN				0	// default disable
	#else
#define MD_MESH_OTA_EN				1   // default disable
	#endif
#endif
#endif
...
#define MD_POWER_ONOFF_EN           0						// compatible with older version
    #else
#define MD_POWER_ONOFF_EN           1 	// because both of them save in same flash sector.
    #endif
#define MD_TIME_EN                  0
#define MD_SCENE_EN                 (1 || NLCP_BLC_EN)
#define MD_SCHEDULE_EN              MD_TIME_EN  // because both of them save in same flash sector.
#define MD_PROPERTY_EN				0
#define	MD_LOCATION_EN				0	// location,sensor,battery use same flash addr, but one sector max store 6 models
#define MD_BATTERY_EN				0
...
#define MAX_LPN_NUM					10   // should be less than or equal to 16
...
#if (PCBA_8258_SEL == PCBA_8258_LUMI_V1_1)
