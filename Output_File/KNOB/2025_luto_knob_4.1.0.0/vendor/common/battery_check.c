...
#ifdef  LVD_DBG_EN
#define DBG_LVD_SEND_STR(x)   Dbg_sendString((s8*)x)
#define DBG_LVD_SEND_INT(x)   Dbg_sendInt(x)
#define DBG_LVD_SEND_HEX(x)   Dbg_sendHex(x)
#else
#define DBG_LVD_SEND_STR(x)
#define DBG_LVD_SEND_INT(x)
#define DBG_LVD_SEND_HEX(x)
#endif
