...
#define NETKEY_A 		{0x11,0x22,0x33,0x44,0x55,0x66,0x77,0x88, 0x99,0xaa,0xbb,0xcc,0xdd,0xee,0xff,0x00}
#define APPKEY_A		{0x01,0x12,0x23,0x34,0x45,0x56,0x67,0x78, 0x89,0x9a,0xab,0xbc,0xcd,0xde,0xef,0xf0}
...
#define SUB_LIST_MAX                    (8)
#endif
#define VIRTUAL_ADDR_ENABLE				0 // disable virtual address to save ram
...
#if   LIGHT_CNT == 1
	#define DEVICE_MASK     0x1
#elif LIGHT_CNT == 2
	#define DEVICE_MASK     0x3
#elif LIGHT_CNT == 3
	#define DEVICE_MASK     0x7
#elif LIGHT_CNT == 4
	#define DEVICE_MASK     0xF
#elif LIGHT_CNT == 5
	#define DEVICE_MASK     0x1F
#elif LIGHT_CNT == 6
	#define DEVICE_MASK     0x3F
#elif LIGHT_CNT == 10
	#define DEVICE_MASK     0x3FF
#elif LIGHT_CNT == 14
    #define DEVICE_MASK     0x3FFF
#elif LIGHT_CNT == 15
...
extern nwk_message_para_t  nwk_control_msg_para[LIGHT_CNT];
