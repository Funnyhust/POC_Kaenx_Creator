...
#define PCBA_8258_LUMI_V1_0                  5   // 48pin
#define PCBA_8258_LUMI_V1_1                  6

#define PCBA_8258_SEL			             PCBA_8258_LUMI_V1_1
...
#define CURTAIN_ENABLE_BINDING               1
#define CONTROL_CURTAIN_INTERNAL_ENABLE      1
...
#define DIMMER_EN_BINDING                    1

#define BIND_APPKEY_PERIODIC                 1
#define RETRY_GET_NW_MODE_FAIL_CONNECTION    5
#define RETRY_GET_NW_MODE_TIME_LEN_MS        (300000)  // 5 Min

// default transition
#define CTL_WITH_FLAG_DEFAULT_POSITION_EN    1

#define KEY_FLASH_DEFAULT                    0

#define CHANGE_DEVICE_NAME_EN                1

#define CACULATOR_FREQ_EN                    1

#define FACT_ENABLE                          1

#define ENABLE_AUTO_ENABLE_VISIBILITY        1

#define ENABLE_SHOW_PRESENT_CURTAIN_LEVEL    1

#define AIR_CONTROL_MODE_AND_FAN_IN_MAIN_EN  1

// Option Button
#if (defined _LM_DOWNLIGHT_) || (defined _LM_RS_) || (defined _POB_LIGHT_) || (defined _LM_DIMMER_)
#define OPTION_BUTTON_ENABLE     0  // Confirm later
#else
#define OPTION_BUTTON_ENABLE     0
#endif
...
//---------------  LED / PWM
    ...
    #define PWMID_Y     (GET_PWMID(PWM_Y, PWM_FUNC_Y))
	...
	#define PWM_W       GPIO_PC3	  //warm
    #define PWM_Y       GPIO_PC4      //white
    ...
    #define PWM_INV_Y   (GET_PWM_INVERT_VAL(PWM_Y, PWM_FUNC_Y))
		...
		// WW
        #define LIGHT_CT_TWO_COLOR    1 // TWO PIN INDEPENDENCE
		#define PWM_HIGHT_SPEED       1
		#else
        #ifdef _COB_LIGHT_
        #define PWM_HIGHT_SPEED       0
		#else
		#define PWM_HIGHT_SPEED       0
		#endif
        #endif
		...
		#define PWM_W       GPIO_PC3	//warm
		#define PWM_Y       GPIO_PB5	//white
		#else
		#define PWM_R       GPIO_PC4	//red
		#define PWM_B       GPIO_PC2    //blue
		#define PWM_G       GPIO_PC3	//green
		#define PWM_W       GPIO_PB4	//warm
		#define PWM_Y       GPIO_PB5	//white
		#endif

   #elif (LIGHT_TYPE_SEL == LIGHT_TYPE_2_CCT)
		#define PWM_R       GPIO_PC4	//red
		#define PWM_B       GPIO_PC0    //blue
		#define PWM_G       GPIO_PD2	//green
		#define PWM_W       GPIO_PB4	//warm
		#define PWM_Y       GPIO_PB5	//white
		...
		#ifdef _MINI_PCB_
		#define PWM_W       GPIO_PC4	//red
		#define PWM_Y       GPIO_PC2    //blue
		#define PWM_B       GPIO_PC3	//green
		#define PWM_R       GPIO_PB5	//warm
		#define PWM_G       GPIO_PD2	//white
		#else
		...
		#define PWM_W       GPIO_PB4	//warm
		#define PWM_Y       GPIO_PB5	//white
        #define PWM_RSV     GPIO_PD2    //reserved
		#endif
    #endif
	...
	#define PWM_FUNC_W    AS_PWM      // AS_PWM_SECOND
    #define PWM_FUNC_Y    AS_PWM      // AS_PWM_SECOND
    #define PWM_FUNC_RSV  AS_PWM      // AS_PWM_SECOND
	...
	#define PWMID_W      (GET_PWMID(PWM_W,   PWM_FUNC_W))
    #define PWMID_Y      (GET_PWMID(PWM_Y,   PWM_FUNC_Y))
    #define PWMID_RSV    (GET_PWMID(PWM_RSV, PWM_FUNC_RSV))
	...
	#define PWM_INV_W    (GET_PWM_INVERT_VAL(PWM_W,   PWM_FUNC_W))
    #define PWM_INV_Y    (GET_PWM_INVERT_VAL(PWM_Y,   PWM_FUNC_Y))
    #define PWM_INV_RSV  (GET_PWM_INVERT_VAL(PWM_RSV, PWM_FUNC_RSV))

#endif

#if LIGHT_TYPE_SEL == LIGHT_TYPE_CT || LIGHT_TYPE_SEL == LIGHT_TYPE_2_CCT
#define GPIO_LED	PWM_W
#else
#define GPIO_LED	PWM_R
#endif

#if LIGHT_TYPE_SEL == LIGHT_TYPE_CT
#define NBR_LED_CONTROL_LIGHT         0x2
#elif LIGHT_TYPE_SEL == LIGHT_TYPE_HSL
#define NBR_LED_CONTROL_LIGHT         0x3
#elif LIGHT_TYPE_SEL == LIGHT_TYPE_CT_HSL
#define NBR_LED_CONTROL_LIGHT         0x5
#elif LIGHT_TYPE_SEL == LIGHT_TYPE_DIM
#define NBR_LED_CONTROL_LIGHT         _DIMMER_CHANNEL_NUMBER_
#elif LIGHT_TYPE_SEL == LIGHT_TYPE_2_CCT
#define NBR_LED_CONTROL_LIGHT         0x4
#else
#define NBR_LED_CONTROL_LIGHT         0x0
#endif
...
#else
#define WATCHDOG_INIT_TIMEOUT		5000  //in mi mode the watchdog timeout is 20s
#endif
