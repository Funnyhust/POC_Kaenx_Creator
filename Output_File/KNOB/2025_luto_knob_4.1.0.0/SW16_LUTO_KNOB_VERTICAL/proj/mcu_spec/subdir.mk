...
proj/mcu_spec/%.o: ../proj/mcu_spec/%.S
	...
	tc32-elf-gcc -Xassembler"D:\Lumi\LM_2025\LUTO\BLE mesh\.src\BLE-LM-luto_knob_2025\2025_luto_knob_4.1.0.0" -DMCU_STARTUP_8258_RET_16K -D__PROJECT_MESH__=1 -DCHIP_TYPE=CHIP_TYPE_8258 -D_SWITCH_DEVICE_=1 -D_BTN_NUMBER_=16 -D_SCREEN_VER_=1 -c -o"$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
