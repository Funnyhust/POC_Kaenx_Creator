...
C_SRCS += \
../vendor/mesh/user/knob/config.c \
../vendor/mesh/user/knob/element.c \
../vendor/mesh/user/knob/knob.c \
../vendor/mesh/user/knob/knob_msg.c 

OBJS += \
./vendor/mesh/user/knob/config.o \
./vendor/mesh/user/knob/element.o \
./vendor/mesh/user/knob/knob.o \
./vendor/mesh/user/knob/knob_msg.o 


# Each subdirectory must supply rules for building sources it contributes
vendor/mesh/user/knob/%.o: ../vendor/mesh/user/knob/%.c
	@echo 'Building file: $<'
