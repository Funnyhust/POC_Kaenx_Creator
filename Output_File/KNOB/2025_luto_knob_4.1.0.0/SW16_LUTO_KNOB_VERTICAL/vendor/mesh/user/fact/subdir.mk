...
C_SRCS += \
../vendor/mesh/user/fact/fact.c \
../vendor/mesh/user/fact/fact_handle.c 

OBJS += \
./vendor/mesh/user/fact/fact.o \
./vendor/mesh/user/fact/fact_handle.o 


# Each subdirectory must supply rules for building sources it contributes
vendor/mesh/user/fact/%.o: ../vendor/mesh/user/fact/%.c
	@echo 'Building file: $<'
