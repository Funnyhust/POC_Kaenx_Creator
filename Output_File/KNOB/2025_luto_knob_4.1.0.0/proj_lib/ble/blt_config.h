...
#define		MY_RF_POWER_INDEX		RF_POWER_P7p02dBm
			#else
#define		MY_RF_POWER_INDEX		RF_POWER_P10p01dBm
    		#endif
		#elif(MCU_CORE_TYPE == MCU_CORE_8278)
...
// Luto knob
#define         FLASH_ADR_RESET_CNT         0x37000
#define			FLASH_ADR_KNOB_CONFIG		0x3e000
...
********************************************/
#define         FLASH_ADR_VENDOR_START          0x78000
#define 		FLASH_ADR_SCENE_BUTTON          0x78000
#define 		FLASH_ADR_EXECUTION_SCENE	    0x79000
#define         FLASH_ADR_BINDING_PARAMS        0x7A000
#define         FLASH_ADR_KNOB_ELE_PAR          0x7B000
#define         FLASH_ADR_ENDPOINT_TYPE         0x7C000
#define         FLASH_ADR_COMMON_ENDPOINT_PAR   0x7D000
#define         FLASH_ADR_COMMON_SCENE_PAR      0x7E000

#define         FLASH_ADR_ADVANCED_CONFIG       0x7F000

#define         FLASH_ADR_VENDOR_END            0x80000
...
//                      MI_BLE_MESH_CER_ADR	         // don't modify
...
#if 1// common
#if (FLASH_1M_ENABLE && (0 == DUAL_MESH_ZB_BL_EN) && (0 == DUAL_MESH_SIG_PVT_EN))
