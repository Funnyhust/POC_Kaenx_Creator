...
#else
#define TTL_DEFAULT             (6)         // max relay count = TTL_DEFAULT - 1
#endif
#define TTL_MAX                 (0x7F)
...
#define SEC_NW_BC_INV_DEF_1S       		(IV_UPDATE_KEEP_TMIE_MIN_S / 10)	// 
		#else
#define SEC_NW_BC_INV_DEF_1S       		(30)	// between 10~600(unit:1s), security network beacon interval default
		#endif
	#endif
#endif
...
#define TL_LOG_LEVEL              TL_LOG_LEVEL_DEBUG
	#endif
#else
#define TL_LOG_LEVEL              TL_LOG_LEVEL_DISABLE // TL_LOG_LEVEL_INFO	// Note firmware size
#endif
