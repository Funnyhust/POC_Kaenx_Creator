...
C_SRCS += \
../vendor/mesh/user/knob/peripheral/curtain.c 

OBJS += \
./vendor/mesh/user/knob/peripheral/curtain.o 


# Each subdirectory must supply rules for building sources it contributes
vendor/mesh/user/knob/peripheral/%.o: ../vendor/mesh/user/knob/peripheral/%.c
	@echo 'Building file: $<'
