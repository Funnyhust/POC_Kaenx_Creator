...
for ep in range(1, 7):
    ep_ui = f"Endpoint {ep} - ..."
    _, rid_name = add_param_basic(f"Btn{ep}_Name", "NameText", "Name String", f"Air conditioning 0{ep}", 14, is_text=True)
...
print("Generated knob_device.xml v11 with AC Setpoint steps and refined defaults")
