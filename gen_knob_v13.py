...
for ep in range(1, 7):
    ...
    # 1. Switch (Renamed to Switch/Switch Status)
    ...
    # 2. CCT (Renamed Power to Switch/Switch Status)
    ...
    # 3. Dimming (Ensuring Status capitalization)
...
with open(output_path, "w", encoding="utf-8") as f:
    f.write("\n".join(lines) + "\n")
print("Generated knob_device.xml v13 with lighting objects renamed to Switch/Switch Status")
