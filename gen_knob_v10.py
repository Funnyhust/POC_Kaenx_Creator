...
parameters = []
parameter_refs = []
com_objects_all = [] # Will store objects and sort them later
...
# Fixed Global Objects (Control first, then Status)
global_objs = [
    create_obj_struct("Global_Switch", "Switch", "1 Bit", "DPST-1-1", "Global Switch"),
...
# Final ComObject Registry with unified numbering and ordering
final_com_objects = []
...
# 2. Endpoints (Store orids back in logic)
...
print("Generated knob_device.xml v10 with standard Object Naming and Ordering")
