...
for ep in range(1, 7):
    ...
    # He byte params
    _, rid_he_step     = add_param_basic(f"Btn{ep}_HeStep", "AcStep", "  Setpoint step", "0", 1) # New
    _, rid_he_min_temp = add_param_basic(f"Btn{ep}_HeMinTemp", "AcTempMin", "  Min temperature", "16", 1) # New
    _, rid_he_max_temp = add_param_basic(f"Btn{ep}_HeMaxTemp", "AcTempMax", "  Max temperature", "30", 1) # New
    ...
    cct_objs = [
        ...
        create_obj_struct(f"Btn{ep}_CctCol", "Color temperature", "2 Bytes", "DPST-7-600", ep_ui),
        ...
        create_obj_struct(f"Btn{ep}_CctColS", "Color temperature status", "2 Bytes", "DPST-7-600", ep_ui, is_status=True)
    ]
    dim_objs = [
    ...
    ac_objs = [
        ...
        create_obj_struct(f"Btn{ep}_AcTar", "Setpoint", "2 Bytes", "DPST-9-1", ep_ui),
        ...
        create_obj_struct(f"Btn{ep}_AcSwi", "Air swing", "1 Bit", "DPST-1-1", ep_ui),
        create_obj_struct(f"Btn{ep}_AcVan", "Louver position", "1 Byte", "DPST-5-10", ep_ui),
        # Status
        create_obj_struct(f"Btn{ep}_AcPowS", "Power status", "1 Bit", "DPST-1-1", ep_ui, is_status=True),
        create_obj_struct(f"Btn{ep}_AcTarS", "Setpoint status", "2 Bytes", "DPST-9-1", ep_ui, is_status=True),
        ...
        create_obj_struct(f"Btn{ep}_AcSwiS", "Air swing status", "1 Bit", "DPST-1-1", ep_ui, is_status=True),
        create_obj_struct(f"Btn{ep}_AcVanS", "Louver position status", "1 Byte", "DPST-5-10", ep_ui, is_status=True)
    ]
    he_objs = [
        create_obj_struct(f"Btn{ep}_HePow", "Power", "1 Bit", "DPST-1-1", ep_ui),
        create_obj_struct(f"Btn{ep}_HeTar", "Setpoint", "2 Bytes", "DPST-9-1", ep_ui),
        create_obj_struct(f"Btn{ep}_HeMode", "Heating mode", "1 Bit", "DPST-1-100", ep_ui),
        create_obj_struct(f"Btn{ep}_HePowS", "Power status", "1 Bit", "DPST-1-1", ep_ui, is_status=True),
        create_obj_struct(f"Btn{ep}_HeTarS", "Setpoint status", "2 Bytes", "DPST-9-1", ep_ui, is_status=True),
        create_obj_struct(f"Btn{ep}_HeModeS", "Heating mode status", "1 Bit", "DPST-1-100", ep_ui, is_status=True),
        create_obj_struct(f"Btn{ep}_HeRmT", "Room temperature", "2 Bytes", "DPST-9-1", ep_ui, is_status=True)
    ]
